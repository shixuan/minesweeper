...
public class MSGUI extends JFrame implements ActionListener {
  ...
  */
  public MSGUI(MSCore ms) {
    ...
    Container gameBoard = new JPanel();
    Container faceBoard = new JPanel();
    faceBoard.setPreferredSize(new Dimension(600, 60));
  ...
  */
  public void finishGame(int win) {
    ...
    if(win == 1)
      ...
      msg.setText("You little bastard cheated to win!!!");
      pop.setTitle("Shit");
    }
    content.add(msg);
